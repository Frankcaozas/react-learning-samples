    ...
    endpoints (build) {
        ...
        return {
            ...
            getStudentsById: build.query({
                ...
                keepUnusedDataFor: 30, // 缓存的过期时间， 默认60
                providesTags: (result, error, id) => [{type:'stu', id:`${id}`}]
            }),
            ...
            updateStudent: build.mutation({
                ...
                invalidatesTags:(result, error, id) => [{type:'stu', id:`${id}`},{type:'stu', id:'list'}]
            }),
